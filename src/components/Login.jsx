    ...
    <>
      <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 px-4 transition-colors duration-300">
        ...
        <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 transition-colors duration-300">
          ...
          {errors && <p className="text-red-500 text-xl">{errors}</p>}
          ...
          <div className="space-y-3">
            ...
            {/* GitHub Button: Softened the dark mode background slightly so it doesn't blend into the main card */}
            <button className="w-full flex items-center justify-center py-2.5 px-4 bg-[#24292F] hover:bg-[#24292F]/90 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg transition-colors duration-200 shadow-sm">
              <svg
